...
class _TransactionsScreenState extends State<TransactionsScreen> {
  ...
  final String baseUrl = 'http://shreelalchand.com/logistics/list-all-transactions';
  final String updateUrl = 'http://shreelalchand.com/logistics/update-transactions';
  final String generatePDFTransactionUrl = "http://shreelalchand.com/logistics/generate-pdf-transaction";
