...
class _GenerateBillScreenState extends State<GenerateBillScreen> {
  ...
  final String generatePDFTransactionUrl = "http://shreelalchand.com/logistics/generate-pdf-bill";
  Future<void> _fetchCurrentBillId() async {
    try {
      final response = await http.get(
        Uri.parse('http://shreelalchand.com/logistics/current-bill-id'),
      );
  ...
  Future<void> _loadVendors() async {
    try {
      final response = await http.get(
        Uri.parse('http://shreelalchand.com/logistics/list-vendor'),
      );
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
        setState(() {
  ...
  Future<void> _loadTrucks() async {
    try {
      final response = await http.get(
        Uri.parse('http://shreelalchand.com/logistics/list-vehicle'),
      );
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
        setState(() {
  ...
  Future<void> _searchBills() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://shreelalchand.com/logistics/list-billing'),
