...
class ReportsService {
  final Dio _dio;
  final String baseUrl = 'http://shreelalchand.com/logistics';
  ...
  static String getPlatformSpecificBaseUrl() {
    if (Platform.isAndroid) {
      return 'http://shreelalchand.com/logistics'; // Android emulator localhost
    } else if (Platform.isIOS) {
      return 'http://shreelalchand.com/logistics'; // iOS simulator localhost
    }
    return 'http://shreelalchand.com/logistics'; // Default fallback
  }
