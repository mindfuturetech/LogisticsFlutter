class TripDetails {
  ...
  final double? differenceInWeight;
  final double? freight;
  final double? diesel;
  final double? dieselAmount;
  final String? dieselSlipNumber;
  final double? tdsRate;
  final double? advance;
  final double? toll;
  final double? adblue;
  final double? greasing;
  final String? billId;
  final Map<String, String?>? dieselSlipImage;
  final Map<String, String?>? loadingAdvice;
  final Map<String, String?>? invoiceCompany;
  final Map<String, String?>? weightmentSlip;
  final String? id;
